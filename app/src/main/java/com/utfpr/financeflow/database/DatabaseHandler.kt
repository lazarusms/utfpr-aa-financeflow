...
class DatabaseHandler(context: Context) :
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        ...
        db?.execSQL("CREATE TABLE IF NOT EXISTS $TABLE_NAME ($COL_ID INTEGER PRIMARY KEY AUTOINCREMENT, $COL_AMOUNT REAL, $COL_DESC TEXT, $COL_DATE TEXT, $COL_TRANSACTION_TYPE)")
