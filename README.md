...
- [X] Componentização da ListTransactionScreen
    - [X] Extrair `SummaryCard` para um arquivo próprio.
    - [X] Extrair `TransactionCardSimple` para um arquivo próprio.
...
- [X] Verificar se temos lugares onde está sendo usado os tipos de transaction de forma hardcoded (e não o enum)
